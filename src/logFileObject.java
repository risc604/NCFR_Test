...
>>>>>>> b7c54626853a7bddada9531f314b690984193f87
    ...
    public ArrayList<Date> dtTosecond(ArrayList<byte[]> data)
    {
		...
		/*
		 //SimpleDateFormat sdf = new SimpleDateFormat("yyyy ï¿½~ MM ï¿½ï¿½ dd ï¿½ï¿½");
		//SimpleDateFormat sdf = new SimpleDateFormat("yyMMddHHmm");
		 //System.out.println("ï¿½tï¿½Î®É¶ï¿½ï¿½ï¿½:" + today );
		 //System.out.println("ï¿½É¶ï¿½ï¿½æ¦¡ï¿½Õ¾ï¿½ï¿½:" + sdf.format(today));
...
=======
    ...
    public ArrayList<Date> dtTosecond(ArrayList<byte[]> data)
    {
		...
		/*
		 //SimpleDateFormat sdf = new SimpleDateFormat("yyyy ¦~ MM ¤ë dd ¤é");
		//SimpleDateFormat sdf = new SimpleDateFormat("yyMMddHHmm");
		 //System.out.println("¨t²Î®É¶¡¬°:" + today );
		 //System.out.println("®É¶¡®æ¦¡½Õ¾ã«á:" + sdf.format(today));
